...
import { play_next, play_previous, setTracks } from '../../setupAudio'
...
export function player() {
  ...
  style={{ flex: 1, padding:25, display:"flex"}}
      ...
      <View style={{display:"flex", flexDirection:"row", justifyContent:"space-between", paddingTop:35, alignItems:"center"}}>
        ...
        <Pressable onPress={()=>{play_previous()}}><Ionicons name="play-back-outline" color={"white"} size={30} ></Ionicons></Pressable>
        <LinearGradient 
        ...
        <TouchableOpacity onPress={()=>{}}><Ionicons name="shuffle-outline" color={"white"} size={30}></Ionicons></TouchableOpacity>
      </View>
